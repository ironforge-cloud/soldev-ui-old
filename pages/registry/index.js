                ...
                <div className="-mt-px flex divide-x divide-gray-200 dark:divide-gray-500">
                  <div className="flex w-0 flex-1">
                    <button
                      ...
                      font-medium text-gray-700 hover:text-gray-500 dark:border-gray-500 dark:text-gray-300 hover:dark:text-gray-100"
                    >
                    ...
                    <Link
                      ...
                      className="relative inline-flex w-0 flex-1 items-center justify-center
                       rounded-br-lg border border-transparent py-4 text-sm font-medium
                        text-gray-700 hover:text-gray-500 dark:border-gray-500 dark:text-gray-300 hover:dark:text-gray-100"
                    >
