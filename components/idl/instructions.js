    ...
    component.push(
      <div className="flex gap-2 pb-1" key={accounts[i].name}>
        ...
        <div className="flex gap-1">
          {accounts[i].isSigner && (
            <span
              className="inline-flex items-center rounded bg-orange-100 px-2 py-0.5
             text-xs font-medium text-orange-800 dark:bg-orange-700 dark:text-orange-50"
            >
              isSigner
            </span>
          )}
          {accounts[i].isMut && (
            <span
              className="inline-flex items-center rounded bg-green-100
             px-2 py-0.5 text-xs font-medium text-green-800 dark:bg-green-800 dark:text-green-50"
            >
              isMut
            </span>
          )}
