    ...
    <div className="py-5">
      <div className="flex justify-between">
        <div className="flex items-center">
          ...
          >
            <span
              className="flex items-center text-sm font-bold text-gray-900 dark:text-gray-200"
              title={author.name}
            >
              {author.name}
              {author.verified ? (
...
rel="noopener noreferrer"
      >
        <div className="mt-1 whitespace-pre-wrap text-gray-600 dark:text-gray-300 text-sm font-medium">
          {!retweetedTweet && text}
        </div>
      </a>
      {media && media.length ? (
      ...
      {quoteTweet ? (
        <div className="pl-5 pr-1 text-xs border-dashed border-2 rounded-lg my-4 border-gray-300 hover:bg-sky-50 dark:border-gray-600 hover:dark:bg-gray-900">
          <Tweet
            key={quoteTweet.id}
      ...
      <div className="flex text-gray-700 dark:text-gray-500 mt-4">
        <a
          className="flex items-center mr-4 text-gray-500 dark:text-gray-500 hover:text-blue-600 transition hover:underline"
          href={replyUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
...
viewBox="0 0 24 24"
        ...
        <a
          className="flex items-center mr-4 text-gray-500 dark:text-gray-500 hover:text-green-600 transition hover:underline"
          href={retweetUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
...
viewBox="0 0 24 24"
        ...
        <a
          className="flex items-center text-gray-500 dark:text-gray-500 hover:text-red-600 transition hover:underline"
          href={likeUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
