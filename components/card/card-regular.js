...
function CardRegular({content, mode, editContent, closeSearch}) {
    ...
    return (
        <div
            className="flex flex-col rounded-lg border max-h-[540px] border-gray-300 dark:border-gray-700 shadow-lg hover:shadow-sky-500/30 dark:hover:shadow-sky-400/20 hover:opacity-95 bg-white dark:bg-gray-800 w-[400px]">
            <a href={content.Url}
               target="_blank"
               rel="noreferrer">
                <Image
            ...
            <div
                className="px-5 pt-5">
                <div
                    className="overflow-hidden h-[275px]">
                    <div
                        className="border-b-2 border-dashed border-gray-700 dark:border-gray-500">
                        <div
                    ...
                    {Array.isArray(content.Tags) && (
                        <div
                            className="mb-1 mt-2 text-sky-500 dark:text-sky-600 cursor-pointer">
                ...
                {/*  Actions */}
                <div
                    className="flex flex-row justify-between items-end pt-2 h-[40px] pb-5">
                    <div>
                        {mode === "edit" ? (
                            <button
