  ...
  return (
    <div>
      <div className="mb-5 flex items-center justify-between">
        <h2 className="text-sm font-medium text-gray-600 dark:text-gray-400">Filter using:</h2>
      </div>
              ...
              className={({ active, checked }) =>
                classNames(
                  ...
                  checked
                    ...
                    : 'border-gray-200 text-gray-500 hover:text-gray-700 dark:text-gray-300',
      ...
      {option === 'address' && (
        <div className="mt-5 flex w-full rounded-md shadow-sm">
          ...
          <input
            ...
            className="block w-28 flex-1 rounded-none rounded-r-md border-gray-300 px-3 py-2 focus:border-sky-500 focus:ring-sky-500 sm:text-sm"
        ...
        <>
          ...
          <div className="mt-5 flex rounded-md shadow-sm">
            ...
            <input
              ...
              id="bytes"
              className="block w-96 flex-1 rounded-none rounded-r-md border-gray-300 px-3 py-2 focus:border-sky-500 focus:ring-sky-500 sm:text-sm"
