              ...
              className={({ active, checked }) =>
                classNames(
                  ...
                  checked
                    ...
                    : 'border-gray-200 text-gray-500 hover:text-gray-700 dark:border-gray-500 dark:text-gray-300',
      ...
      {option === 'address' && (
        <div className="mt-5 flex w-full rounded-md shadow-sm">
          <span
           ...
           bg-gray-50 px-3 text-gray-500 dark:border-gray-500 dark:bg-gray-700 dark:text-gray-300 sm:text-sm"
          >
            account
          </span>
          <input
            ...
            focus:border-sky-500 focus:ring-sky-500 dark:border-gray-500 dark:bg-gray-700
      ...
      {option === 'memcmp' && (
        <>
          <div className="mt-5 flex w-fit rounded-md shadow-sm">
            <span
              className="inline-flex items-center rounded-l-md border border-r-0 border-gray-300
             bg-gray-50 px-3 text-gray-500 dark:border-gray-500 dark:bg-gray-700 dark:text-gray-400 sm:text-sm"
            >
              offset
            </span>
            <input
              ...
              className="block w-28 flex-1 appearance-none rounded-none rounded-r-md
               border-gray-300 px-3 py-2 outline-none dark:border-gray-500 dark:bg-gray-700 dark:text-gray-400 sm:text-sm"
              placeholder="1"
            />
          </div>
          ...
          <div className="mt-5 flex rounded-md shadow-sm">
            <span
             ...
             border-gray-300 bg-gray-50 px-3 text-gray-500 dark:border-gray-500 dark:bg-gray-700 dark:text-gray-400 sm:text-sm"
            >
              bytes
            </span>
            <input
              ...
              className="block w-96 flex-1 rounded-none rounded-r-md border-gray-300 px-3 py-2
                dark:border-gray-500 dark:bg-gray-700 dark:text-gray-400 sm:text-sm"
