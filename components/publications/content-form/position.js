  ...
  return (
    <div className="flex flex-col items-center dark:text-stone-300 text-sm font-medium text-gray-700">
      ...
      <select
        id="position"
        name="position"
        className="mt-1  block w-auto pl-3 pr-10 py-2 text-base border-gray-300 dark:bg-stone-400 dark:border-stone-500 dark:text-stone-800 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
        value={position}
        onChange={(e) =>
