...
function Card({ content, closeSearch }) {
  ...
  return (
    <div className="relative flex flex-col rounded-lg h-[340px] hover:bg-opacity-80 overflow-visible w-[400px] hover:shadow-sky-500/30 dark:hover:shadow-sky-400/20 shadow-lg bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 min-h-full">
      <Link
